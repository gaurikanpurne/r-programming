...
#----Read the dataset------
getwd()
#setwd("C:/Program Files/R/R/KanpurneGauri")
#Plan_Dataset <- read.csv("InsurancePlanSubscription-2017.csv")
Plan_Dataset <- read.csv("C:/Program Files/R/R/KanpurneGauri/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
sm2 <- read.csv("C:/Program Files/R/R/KanpurneGauri/InsurancePlanSubScriptions-2018.csv")
View(sm2)
